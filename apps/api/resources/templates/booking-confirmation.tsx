...
export default function BookingConfirmationTemplate({
	...
	return (
		<EmailLayout title={t.title} preview={t.preview(workshopTitle)}>
			...
			<Text style={emailStyles.paragraph}>{t.body(workshopTitle, patissierName)}</Text>
			...
			<Section>
				<table style={emailStyles.infoTable} cellPadding="0" cellSpacing="0">
					...
					<tr>
						<td style={{ ...emailStyles.infoRow, borderBottom: 'none' }}>{t.remainingLabel}</td>
						<td style={{ ...emailStyles.infoValue, borderBottom: 'none' }}>{remainingAmount}</td>
					</tr>
				</table>
			</Section>
