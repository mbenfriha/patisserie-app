...
import { useSiteBasePath, useSiteProfile } from '../site-provider'
	...
	return (
		<footer className="border-t border-[var(--gold)]/20 bg-[#1A1A1A] px-6 pt-16 pb-8 text-center">
				...
				<div className="mt-6 flex items-center justify-center gap-4">
					{social.instagram && (
						<a
							...
							target="_blank"
							rel="noreferrer"
							className="text-[var(--gold)] opacity-70 transition-opacity duration-300 hover:opacity-100"
					...
					{social.customUrl && (
						<a
							href={social.customUrl}
							target="_blank"
							rel="noreferrer"
							className="text-[var(--gold)] opacity-70 transition-opacity duration-300 hover:opacity-100"
							aria-label={social.customLabel || 'Lien'}
						>
							<svg
								width="20"
								height="20"
			...
			<p className="mt-6 font-[family-name:'Josefin_Sans'] text-xs text-white/30">
				&copy; {new Date().getFullYear()} {profile.businessName} &mdash; Tous droits
